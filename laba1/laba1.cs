...
{ 
    class Program
    {
        ...
        //    //Console.Write("Введите значение типа object: ");
        //    //object myobject = Convert.ChangeType(Object, Console.ReadLine());
        //    //Console.WriteLine($"Результат: {myobject}");
        ...
        //    Point.Z = 100;
        //    myHeap = Point;
        //    //struct unboxPoint = (struct)myHeap;
